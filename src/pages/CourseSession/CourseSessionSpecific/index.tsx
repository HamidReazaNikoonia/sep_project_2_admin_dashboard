...
import { useCourseSession, useUpdateCourseSession } from '@/API/CourseSession/courseSession.hook';
                            ...
                            <div>
                                ...
                                <div className='flex w-full'>
                                    <div className="flex mr-2">
                                        {Array.isArray(course.coaches) && course.coaches.length !== 0 && course.coaches.map(coach => (
                                            <div className='pb-5'>
                                                {coach?.avatar_img ? (<img className="border-2 border-white rounded-full h-12 w-12 -mr-4" src={`${SERVER_FILE}/${course.avatar_img?.file_name || ''}`} alt={course.avatar_img?.file_name} />) : (
                                                    <Avatar 
                                                    alt={`${coach.first_name} ${coach.last_name}`}
                                                    sx={{ bgcolor: stringToColor(coach.first_name + ' ' + coach.last_name), fontSize: '14px', marginRight: '-8px', border: '2px solid white', width: '48px', height: '48px' }}
                                                  >
                                ...
                                <div>
                                    {Array.isArray(course.coaches) && course.coaches.length !== 0 && (
                                        <ul>
                    ...
                    <StyledPaper sx={{ p: { xs: 0, md: 4 } }}>
                        ...
                        <Grid container spacing={2}>
                            {(course.coaches || course.sessions) ? (
                                <ScheduleCoachTimeView sessions={course.sessions} coaches={course.coaches} />
                            ) : (
